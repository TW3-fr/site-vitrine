/**
 * Départements géographiques français (code INSEE) — @tw3/domain
 * Partagé entre site web et application mobile pour le filtre Réseau.
 */
export const DEPARTEMENTS_GEO: Record<string, string> = {
  ...
  '16': '16 Charente', '17': '17 Charente-Maritime', '18': '18 Cher', '19': '19 Corrèze', '21': "21 Côte-d'Or",
  '22': "22 Côtes-d'Armor", '23': '23 Creuse', '24': '24 Dordogne', '25': '25 Doubs', '26': '26 Drôme',
  '27': '27 Eure', '28': '28 Eure-et-Loir', '29': '29 Finistère', '2A': '2A Corse-du-Sud', '2B': '2B Haute-Corse',
  ...
  '69': '69 Rhône', '70': '70 Haute-Saône', '71': '71 Saône-et-Loire', '72': '72 Sarthe', '73': '73 Savoie',
  '74': '74 Haute-Savoie', '75': '75 Paris', '76': '76 Seine-Maritime', '77': '77 Seine-et-Marne',
  '78': '78 Yvelines', '79': '79 Deux-Sèvres', '80': '80 Somme', '81': '81 Tarn', '82': '82 Tarn-et-Garonne',
  '83': '83 Var', '84': '84 Vaucluse', '85': '85 Vendée', '86': '86 Vienne', '87': '87 Haute-Vienne',
  '88': '88 Vosges', '89': '89 Yonne', '90': '90 Territoire de Belfort', '91': '91 Essonne',
  '92': '92 Hauts-de-Seine', '93': '93 Seine-Saint-Denis', '94': '94 Val-de-Marne', '95': "95 Val-d'Oise",
  '971': '971 Guadeloupe', '972': '972 Martinique', '973': '973 Guyane', '974': '974 La Réunion', '976': '976 Mayotte',
}

/** Codes départements dans l'ordre INSEE */
export const DEPARTEMENTS_GEO_ORDERED: string[] = [
