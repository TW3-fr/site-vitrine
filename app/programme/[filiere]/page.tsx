...
const FILIERE_CONTENT: Record<string, {
  ...
  scientifique: {
    ...
    integrationSchools: [
      ...
      { name: "Centrale Lyon", url: "https://www.ec-lyon.fr/", logo: "https://commons.wikimedia.org/wiki/Special:FilePath/Logo_%C3%89cole_centrale_de_Lyon_-_2022.svg?width=400" },
