      ...
      <section className="py-8 md:py-12 px-4 md:px-12 bg-background">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8">
          ...
          <Link href="/programme/scientifique" className="group h-full">
            <Card className="h-full hover:border-primary/50 transition-colors group-hover:shadow-md cursor-pointer flex flex-col justify-between">
              <CardHeader>
                <div className="w-16 h-16 bg-accent/30 rounded-2xl flex items-center justify-center text-primary mb-6 group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
              ...
              <CardFooter className="pt-6 border-t border-border mt-6">
                <span className="text-primary font-bold flex items-center gap-2 group-hover:underline">
                  Découvrir le cursus <ArrowUpRight className="w-4 h-4 group-hover:rotate-45 transition-transform" />
                </span>
              </CardFooter>
            </Card>
          </Link>
