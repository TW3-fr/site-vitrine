        ...
        <div className="container mx-auto max-w-5xl grid md:grid-cols-2 gap-8 md:gap-10">
          ...
          <div className="space-y-12">
            ...
            <div className="p-8 bg-card border border-border rounded-3xl relative overflow-hidden group hover:border-primary/50 transition-colors">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-8 relative z-10">L'Institut vit grâce aux dons. Votre contribution nous permet d'organiser plus d'événements et d'accompagner plus d'élèves gratuitement.</p>
